...
if __name__ == '__main__':
    ...
    subgraph_dict_not_watermarked, _ = collect_subgraphs_within_single_graph_for_watermarking(data, dataset_name, use_train_mask=True, subgraph_kwargs=subgraph_kwargs, not_watermarked=True, seed=2575)
    ...
    if args.prune==True:
        ...
        for amount in np.linspace(0,1,11)[:-1]:
            ...
            confidence_levels.append(match_count_conf)
